...
const AgentSidebar: React.FC = () => {
  ...
  return (
    <div className="no-canvas-interaction h-full flex flex-col bg-white border border-[#E9ECEF] rounded-[1.2rem] overflow-hidden relative shadow-sm">
      <header className="px-4 py-3 flex items-center justify-end gap-1 border-b border-[#F8F9FA]">
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto px-6 py-4 space-y-6 scroll-smooth custom-scrollbar">
        {messages.length === 0 ? (
          <div className="space-y-6">
            <div className="mt-1">
               <div className="w-9 h-9 bg-black rounded-full flex items-center justify-center text-[11px] text-white font-black mb-4 shadow-lg">L</div>
               <h1 className="text-[22px] font-extrabold text-black tracking-tight leading-tight">AI 导演助手已就绪</h1>
               <p className="text-[14px] text-[#868E96] mt-1 font-medium">描述你的电影创意，我将协助你完成分镜与剧本</p>
            </div>
